...
<div class="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-6">
	<div class="w-full max-w-sm">
		<div class="text-center mb-8">
			<div class="w-14 h-14 mx-auto mb-4 rounded-md flex items-center justify-center shadow-lg" style="background: linear-gradient(135deg, #3ACACA, #2BA3A3); box-shadow: 0 10px 15px -3px rgba(58, 202, 202, 0.3);">
		...
		<div class="bg-slate-800/50 backdrop-blur rounded-md p-6 border border-white/10">
			...
			{:else if step === 'need_both'}
				<div class="text-center py-4">
					<div class="w-16 h-16 mx-auto mb-4 rounded-md flex items-center justify-center" style="background-color: rgba(58, 202, 202, 0.1);">
			...
			{:else if step === 'scan_backup'}
				<div class="text-center py-2">
					<div class="w-12 h-12 mx-auto mb-3 bg-emerald-500/20 rounded-md flex items-center justify-center">
					...
					<div class="w-14 h-14 mx-auto mb-4 bg-amber-500/10 rounded-md flex items-center justify-center">
					...
					<button
						...
						class="w-full bg-slate-700/50 text-slate-300 py-3 rounded-md text-sm hover:bg-slate-700 transition-colors border border-white/5"
					>
						不需要副卡
					</button>
				...
				<form onsubmit={(e) => { e.preventDefault(); register(); }} class="space-y-4">
					<div>
						...
						<input
							...
							type="text"
							bind:value={nickname}
							class="w-full px-4 py-3 bg-slate-700/50 border border-white/10 rounded-md text-white placeholder-slate-500 focus:outline-none focus:ring-2"
					...
					<button
						type="submit"
						disabled={loading}
						class="w-full text-white py-3 rounded-md font-medium transition-all disabled:opacity-50 shadow-lg mt-2"
